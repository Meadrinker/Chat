...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'chat_service' => 'getChatServiceService',
            ...
            'validator_service' => 'getValidatorServiceService',
        );
        $this->aliases = array(
    ...
    /*
     * Gets the public 'chat_service' shared service.
     *
     * @return \AppBundle\Service\ChatService
     */
    protected function getChatServiceService()
    {
        return $this->services['chat_service'] = new \AppBundle\Service\ChatService($this->get('doctrine.orm.default_entity_manager'), $this->get('validator_service'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'chat', 'user' => 'root', 'password' => 'test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_42114597144a4aa79b016bdce657a3c836b7f234e7b97f3a897af3b9a31efb0d');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cca7445e90b0ebe2111f2cdc06ac0cfa372e39ff');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5bffd48b241121.64866517')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'cca7445e90b0ebe2111f2cdc06ac0cfa372e39ff',
            'locale' => 'en',
            ...
            'kernel.secret' => 'cca7445e90b0ebe2111f2cdc06ac0cfa372e39ff',
